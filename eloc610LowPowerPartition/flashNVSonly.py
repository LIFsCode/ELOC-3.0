...
def flash_nvs_bin(project_root, env):
    ...
    nvs_bin_path = os.path.join(project_root, 'eloc610LowPowerPartition', '.pio', 'build', 'esp32dev', 'nvs.bin')
    ...
    upload_command = [
        'C:\\Users\edsteve\\AppData\\Local\\Programs\\Python\\Python313\\python.exe',  # Adjust as necessary
        '-m', 'esptool',
        '--chip', 'esp32',
...
try:
    ...
    env = 'esp32dev-ei'  # Adjust environment as necessary
