...
// Board specific configurations
        ...
        // ESP32_DevKitc_V4 board definitions
        // https://docs.espressif.com/projects/esp-idf/en/stable/esp32/hw-reference/esp32/get-started-devkitc.html
        // Conflicting pins as using JTAG

        // #define STATUS_LED                      // Not fitted on board
        // #define BATTERY_LED                     // Not fitted on board
        #define GPIO_BUTTON GPIO_NUM_0
        // #define VOLTAGE_PIN
        #define BAT_ADC ADC1_CHANNEL_6             // Not fitted on board

        // I2S Config
        #define I2S_MIC_LEFT_RIGHT_CLOCK GPIO_NUM_22    // LRCLK
        #define I2S_MIC_SERIAL_CLOCK GPIO_NUM_26        // BCLK
        #define I2S_MIC_SERIAL_DATA GPIO_NUM_21         // DOUT
        #define I2S_MIC_SEL                             // Tied low for left
